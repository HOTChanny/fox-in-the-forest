...
public class Fox_Move : MonoBehaviour {
	...
	void Attack(){			//c누르면 공격 함수 attack랑 attackend랑 같이 묶어										//I activated the attack animation and when the 
	...
	void OnTriggerEnter2D(Collider2D other){	//데미지 받기-트리거 함수	//Case of Bullet
		if(other.tag=="Enemy"){
	...
	void OnCollisionEnter2D(Collision2D other) { //데미지 받기- 충돌 함수						//Case of Touch
